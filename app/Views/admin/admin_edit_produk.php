...
<body>
    ...
    <form action="<?=base_url('admin/ubah_produk/'.$produk['id_produk'])?>" method="post" enctype="multipart/form-data" class="p-5">
      ...
      <input type="text" name="nama_pro" id="nama_pro" class="bg-secondary bg-opacity-10 form-control" placeholder="Masukkan Nama Produk" value="<?= $produk['nama_produk']?>" required >
      ...
      <select id="jenis_pro" class="form-select" name="jenis_pro" placeholder="Pilih Jenis Produk" >
        <option selected><?= $produk['jenis_produk']?></option>
      ...
      <input type="text" name="harga_pro" id="harga_pro" class="bg-secondary bg-opacity-10 form-control" placeholder="Masukkan Harga Produk" required value="<?= $produk['harga_produk']?>">
      <label for="">Informasi Produk</label>
      <textarea name="info_pro" id="info_pro" cols="30" rows="5" class="bg-secondary bg-opacity-10 form-control" placeholder="Masukkan Informasi Produk"><?= $produk['informasi_produk']?></textarea>
